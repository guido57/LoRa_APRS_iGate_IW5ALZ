...
namespace Utils {
    ...
    void processStatus() {
        ...
        if (WiFi.status() == WL_CONNECTED && Config.aprs_is.active && Config.beacon.sendViaAPRSIS) {
            delay(1000);
            status += ",qAC:>https://github.com/guido57/LoRa_APRS_iGate " + versionDate;
        ...
        if (statusAfterBoot && !Config.beacon.sendViaAPRSIS && Config.beacon.sendViaRF) {
            delay(2000);
            status += ":>https://github.com/guido57/LoRa_APRS_iGate " + versionDate;
    ...
    void setupDisplay() {
        ...
        show_display(" LoRa APRS", "", "   ( iGATE & DIGI )", "", "", " IW5ALZ ", "      " + versionDate, 4000);
        #ifdef INTERNAL_LED_PIN
