...
namespace LoRa_Utils {
    ...
    void sendNewPacket(const String& newPacket) {
        ...
        if (state == RADIOLIB_ERR_NONE) {
            ...
            Utils::print(String(millis()) + " ---> LoRa Packet Tx    : ");
            Utils::println(newPacket);
        } else {
            Utils::print(F("sendNewPacket(): failed, code "));
        ...
        if (operationDone) {
            ...
            if (transmitFlag) {
                ...
                if (state == RADIOLIB_ERR_NONE) {
                    ...
                    Utils::print((String(millis()) + " receive_packet(): failed, code "));
                    Utils::println(String(state));
                    Utils::println("packet: " + packet); 
                    packet = "";
                }
            }
        }
